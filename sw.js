...
const SHELL = [
  ...
  './assets/css/feature/planner.css?v=2',
  ...
  './assets/js/feature/start/start.js?v=13',
  './assets/js/feature/start/wetter-chip.js?v=7',
  './assets/js/feature/start/heute.js?v=9',
  ...
  './assets/js/shell.js?v=16',
  './assets/js/router.js?v=12',
  ...
  './assets/js/pose.js',
  './assets/js/feature/video/video.js?v=8',
  './assets/css/feature/video.css?v=1',
  './assets/js/feature/einheit/einheit.js?v=10',
  './assets/js/briefing.js',
  './assets/js/nav.js?v=15',
  './assets/js/groups.js',
  './assets/js/feature/gruppe/gruppe.js?v=16',
