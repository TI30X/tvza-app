...
const CACHE = 'tvza-v.35.75.0';
// Shell revision 35: group food, training shares, own plans, celebrations.
const FIREBASE_SDK = [
...
const SHELL = [
  ...
  './datenschutz.html',
  './betreiber.html',
  './assets/css/kit.css?v=39',
  './assets/css/feature/willkommen.css?v=5',
  './assets/css/feature/nutzung.css?v=2',
  ...
  './assets/js/feature/start/start.js?v=34',
  './assets/js/feature/start/wetter-chip.js?v=21',
  './assets/js/feature/start/heute.js?v=27',
  './assets/js/feature/start/ueberblick.js?v=3',
  ...
  './assets/js/foods.js',
  './assets/js/essen-modell.js',
  './assets/js/training-teilen.js',
  './assets/js/plan-bauer.js',
  './assets/js/uebungen-bibliothek.js',
  './assets/js/eigene-plaene.js',
  './assets/js/feature/training/plan-bauen.js',
  './assets/js/training-freigaben.js',
  './assets/js/feature/training/teilen.js',
  './assets/js/feature/geteilt/geteilt.js?v=1',
  './assets/css/feature/geteilt.css?v=3',
  './pages/geteilt.html',
  './assets/js/essen.js',
  './assets/js/feature/essen/erfassung.js',
  './assets/css/feature/essen.css?v=2',
  './assets/js/itinerary.js',
  './assets/js/programm.js',
  './assets/js/reise-uebernahme.js',
  './assets/js/einladung.js',
  './assets/js/kreis-einladung.js',
  './assets/js/ki.js',
  './assets/js/ki-pille.js',
  './assets/js/chat-senden.js',
  './assets/js/calendar-interop.js',
  './assets/js/calendar-view.js',
  './assets/js/matura-sync.js',
  './assets/js/shell.js?v=30',
  './assets/js/router.js?v=20',
  './assets/js/wechsel.js',
  './assets/js/reminders-overlay.js',
  './assets/js/settings-layer.js',
  './assets/js/hints.js',
  './assets/js/termine.js',
  './assets/js/fispunkte.js',
  './assets/js/einheit.js',
  './assets/js/protokoll-sicherung.js',
  ...
  './assets/js/nachricht-ki.js',
  './assets/js/gruppen-folge.js',
  './assets/js/tastatur.js',
  './assets/js/kalender-teams.js',
  './assets/js/feature/kalender/kalender.js?v=20',
  ...
  './assets/js/pose.js',
  './assets/js/feature/video/video.js?v=22',
  './assets/css/feature/video.css?v=1',
  './assets/js/feature/einheit/einheit.js?v=29',
  './assets/css/feature/einheit.css?v=3',
  './assets/js/briefing.js',
  './assets/js/nav.js?v=31',
  './assets/js/groups.js',
  ...
  './assets/js/feature/gruppe/gruppe.js?v=43',
  './assets/css/feature/gruppe.css?v=14',
  ...
  './assets/js/feature/matura/uebersicht.js?v=22',
  './assets/js/feature/matura/uebersicht-ansicht.js',
  './assets/js/feature/matura/tracker.js?v=22',
  './assets/js/feature/matura/tracker-ansicht.js',
  './pages/training.html',
  './assets/js/training-parser.js',
  './assets/data/training/images.json',
  './assets/js/feature/training/training.js?v=23',
  './assets/js/feature/woche/woche.js',
  './assets/css/feature/woche.css?v=3',
  './pages/admin.html',
  './public.html',
  './assets/icons/tvza.svg',
  './assets/icons/tvza-192.png',
  './assets/js/feature/oeffentlich/oeffentlich.js?v=1',
  './assets/css/feature/oeffentlich.css?v=3',
  ...FIREBASE_SDK,
];
