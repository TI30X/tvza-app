...
const CACHE = 'tvza-v.35.71.0';
// Shell revision 31: one local assistant suggestion and a route-aware group header.
const FIREBASE_SDK = [
...
const SHELL = [
  ...
  './assets/js/feature/start/ueberblick.js?v=2',
  ...
  './assets/js/feature/kalender/kalender.js?v=19',
  ...
  './assets/js/feature/einheit/einheit.js?v=28',
  ...
  './assets/js/feature/gruppe/gruppe.js?v=40',
  ...
  './assets/js/feature/training/training.js?v=21',
