...
const CACHE = 'tvza-v.31.2.15';
// Shell revision 24: coordinated route skeleton and one-piece content reveal.
const FIREBASE_SDK = [
...
const SHELL = [
  ...
  './assets/js/shell.js?v=3',
  './assets/js/router.js?v=3',
  './assets/js/reminders-overlay.js',
  './assets/js/settings-layer.js',
  './assets/js/hints.js',
  './assets/js/nav.js?v=3',
  './pages/bereiche.html',
