...
const SHELL = [
  ...
  './assets/js/feature/start/start.js?v=15',
  './assets/js/feature/start/wetter-chip.js?v=9',
  './assets/js/feature/start/heute.js?v=12',
  ...
  './assets/js/feature/kalender/kalender.js?v=4',
  ...
  './assets/js/pose.js',
  './assets/js/feature/video/video.js?v=10',
  './assets/css/feature/video.css?v=1',
  './assets/js/feature/einheit/einheit.js?v=14',
  './assets/js/briefing.js',
  './assets/js/nav.js?v=17',
  './assets/js/groups.js',
  './assets/js/feature/gruppe/gruppe.js?v=20',
