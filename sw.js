...
const SHELL = [
  ...
  './assets/js/shell.js?v=23',
  './assets/js/router.js?v=17',
  ...
  './assets/js/feature/kalender/kalender.js?v=9',
  ...
  './assets/js/pose.js',
  './assets/js/feature/video/video.js?v=15',
  './assets/css/feature/video.css?v=1',
  './assets/js/feature/einheit/einheit.js?v=19',
