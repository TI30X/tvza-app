...
const SHELL = [
  ...
  './assets/js/feature/start/start.js?v=17',
  './assets/js/feature/start/wetter-chip.js?v=10',
  './assets/js/feature/start/heute.js?v=13',
  ...
  './assets/js/feature/kalender/kalender.js?v=5',
  ...
  './assets/js/pose.js',
  './assets/js/feature/video/video.js?v=11',
  './assets/css/feature/video.css?v=1',
  './assets/js/feature/einheit/einheit.js?v=15',
  './assets/js/briefing.js',
  './assets/js/nav.js?v=18',
  './assets/js/groups.js',
  './assets/js/feature/gruppe/gruppe.js?v=22',
