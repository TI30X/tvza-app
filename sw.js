...
const SHELL = [
  ...
  './assets/js/feature/start/start.js?v=21',
  './assets/js/feature/start/wetter-chip.js?v=13',
  './assets/js/feature/start/heute.js?v=16',
  ...
  './assets/js/shell.js?v=22',
  './assets/js/router.js?v=16',
  ...
  './assets/js/feature/kalender/kalender.js?v=8',
  ...
  './assets/js/pose.js',
  './assets/js/feature/video/video.js?v=14',
  './assets/css/feature/video.css?v=1',
  './assets/js/feature/einheit/einheit.js?v=18',
  './assets/js/briefing.js',
  './assets/js/nav.js?v=21',
  './assets/js/groups.js',
  './assets/js/feature/gruppe/gruppe.js?v=26',
