...
const SHELL = [
  ...
  './assets/js/feature/start/start.js?v=31',
  './assets/js/feature/start/wetter-chip.js?v=19',
  './assets/js/feature/start/heute.js?v=25',
  ...
  './assets/js/feature/kalender/kalender.js?v=17',
  ...
  './assets/js/pose.js',
  './assets/js/feature/video/video.js?v=20',
  './assets/css/feature/video.css?v=1',
  './assets/js/feature/einheit/einheit.js?v=26',
  ...
  './assets/js/feature/gruppe/gruppe.js?v=36',
