...
const SHELL = [
  ...
  './assets/js/feature/start/start.js?v=28',
  './assets/js/feature/start/wetter-chip.js?v=17',
  './assets/js/feature/start/heute.js?v=21',
  ...
  './assets/js/feature/kalender/kalender.js?v=14',
  ...
  './assets/js/pose.js',
  './assets/js/feature/video/video.js?v=18',
  './assets/css/feature/video.css?v=1',
  './assets/js/feature/einheit/einheit.js?v=22',
  ...
  './assets/js/feature/gruppe/gruppe.js?v=32',
