...
const SHELL = [
  ...
  './assets/js/theme.js',
  // Der Start traegt seinen Code seit v.35.12.0 in eigenen Dateien.
  ...
  './assets/js/feature/bereiche/bereiche.js?v=1',
