...
const SHELL = [
  ...
  './assets/js/feature/start/start.js?v=27',
  './assets/js/feature/start/wetter-chip.js?v=16',
  './assets/js/feature/start/heute.js?v=20',
  ...
  './assets/js/shell.js?v=25',
  './assets/js/router.js?v=18',
  ...
  './assets/js/feature/kalender/kalender.js?v=13',
  ...
  './assets/js/pose.js',
  './assets/js/feature/video/video.js?v=17',
  './assets/css/feature/video.css?v=1',
  './assets/js/feature/einheit/einheit.js?v=21',
  './assets/js/briefing.js',
  './assets/js/nav.js?v=25',
  './assets/js/groups.js',
  ...
  './assets/js/feature/gruppe/gruppe.js?v=31',
