...
const SHELL = [
  ...
  './assets/js/pose.js',
  './assets/js/feature/video/video.js?v=9',
  './assets/css/feature/video.css?v=1',
  './assets/js/feature/einheit/einheit.js?v=13',
  './assets/js/briefing.js',
  './assets/js/nav.js?v=16',
  './assets/js/groups.js',
  './assets/js/feature/gruppe/gruppe.js?v=19',
