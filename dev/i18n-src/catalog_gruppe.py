...
'grp.planDateiWaehlen': ('Excel-Datei wählen', 'Choose Excel file', 'Choisir le fichier Excel', 'Scegli file Excel',
                         'Wybierz plik Excel', 'Excel-bestand kiezen', 'Elegir archivo Excel'),
