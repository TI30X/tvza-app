...
import { ICONS, icon, areaModuleKeys, TABS, mountRail, kontoKnopf, setzeKonto } from './shell.js?v=20';
import { mountAppRouter } from './router.js?v=14';
...
export { ownsTab } from './shell.js?v=20';
