...
import { ICONS, icon, areaModuleKeys, TABS, mountRail, kontoKnopf, setzeKonto } from './shell.js?v=21';
import { mountAppRouter } from './router.js?v=15';
...
export { ownsTab } from './shell.js?v=21';
