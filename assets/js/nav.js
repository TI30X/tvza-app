...
import { ICONS, icon, areaModuleKeys, TABS, mountRail, kontoKnopf, setzeKonto } from './shell.js?v=22';
import { mountAppRouter } from './router.js?v=16';
...
export { ownsTab } from './shell.js?v=22';
