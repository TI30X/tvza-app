...
export const DEFAULT_MODULES = { ski:false, food:true, trip:true, matura:false, maturatracker:false, training:false, projects:false, watch:true, weather:true, dm:true, admin:false };
