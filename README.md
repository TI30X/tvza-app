...
- `kreis/{uid}` — der TVZA-Kreis `{ seit }` (v.35.48.0): Freunde und Familie. Schreiben nur
  der Admin, zusammen mit dem Profilfeld `kreis`; auflisten darf, wer selbst darauf steht.
